package com.psr.ibssc_2021.firebase
...
import com.psr.ibssc_2021.activities.MainActivity
import com.psr.ibssc_2021.activities.MyProfile
import com.psr.ibssc_2021.activities.sign_in
import com.psr.ibssc_2021.activities.sign_up
        ...
        Firestore.collection(Constants.Users)
            ...
            .addOnSuccessListener {document->
                ...
                when (activity){
                    ...
                    is MainActivity->activity.updateNavdetails(loggedInUser)
                    is MyProfile->activity.setUserDataInUI(loggedInUser)
                }
